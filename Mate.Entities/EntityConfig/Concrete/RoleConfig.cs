...
namespace Mate.Entities.EntityConfig.Concrete
{
    public class RoleConfig : BaseConfig<Role>
    {
        public override void Configure(EntityTypeBuilder<Role> builder)
        {
            ...
            builder.HasData(new Role() { Id = Guid.NewGuid().ToString(), RoleName = "Admin", CreatedAt = DateTime.Now });

            builder.HasData(new Role() { Id = Guid.NewGuid().ToString(), RoleName = "User", CreatedAt = DateTime.Now });
        }
    }
