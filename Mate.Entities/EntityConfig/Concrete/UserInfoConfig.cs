...
namespace Mate.Entities.EntityConfig.Concrete
{
	public class UserInfoConfig : BaseConfig<UserInfo>
	{
		public override void Configure(EntityTypeBuilder<UserInfo> builder)
		{
			...
			builder.HasData(new UserInfo() { Name = "İdil", SurName = "Erdoğan", TcNo = "12212212211", GSM = "05391111111", Email = "idilerdogan@sabanciuniv.edu", Address = " uxi sokak. Lola Apt. Paksim Caddesi, No:11", City = "İstanbul", District = "Maltepe", Password = "qweasd" });
